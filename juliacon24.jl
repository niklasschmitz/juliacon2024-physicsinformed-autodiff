...
md"""
# Physics-informed Automatic Differentiation

Examples from Density Functional Theory in **DFTK.jl**
...
html"""
<a title="Dnn87, CC BY 3.0 &lt;https://creativecommons.org/licenses/by/3.0&gt;, via Wikimedia Commons" href="https://commons.wikimedia.org/wiki/File:Lithiumcut_cropped.jpg"><img width="512" alt="Lithiumcut cropped" src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/ed/Lithiumcut_cropped.jpg/512px-Lithiumcut_cropped.jpg?20240703041234"></a>
<br>
"A freshly cut sample of lithium, with some oxides already formed."
<br>
Credit:
<a href="https://commons.wikimedia.org/wiki/File:Lithiumcut_cropped.jpg">Dnn87</a>, <a href="https://creativecommons.org/licenses/by/3.0">CC BY 3.0</a>, via Wikimedia Commons
"""

# ╔═╡ d97e9f68-2bc9-4e2e-808c-9c2afb625b99
md"""
### A perfect Lithium crystal
"""

# ╔═╡ 73e28885-7dd1-4b8d-b1d5-160ba24c5d8f
html"""
<a title="Thierry Dugnolle, CC BY-SA 4.0 &lt;https://creativecommons.org/licenses/by-sa/4.0&gt;, via Wikimedia Commons" href="https://commons.wikimedia.org/wiki/File:A_very_little_body-centered_cubic_stone.gif"><img width="256" alt="A very little body-centered cubic stone" src="https://upload.wikimedia.org/wikipedia/commons/f/f3/A_very_little_body-centered_cubic_stone.gif?20231016132915"></a>

<a href="https://commons.wikimedia.org/wiki/File:A_very_little_body-centered_cubic_stone.gif">Thierry Dugnolle</a>, <a href="https://creativecommons.org/licenses/by-sa/4.0">CC BY-SA 4.0</a>, via Wikimedia Commons
"""
...
# ╔═╡ 4fdc1f01-662c-497b-adbd-61d6f76000e9
md"""
**TODO insert DFT equations**
"""
...
manifest_format = "2.0"
project_hash = "c627920c117a1f29da869789a4cabb5b113b5e4b"
...
[[deps.AtomsIO]]
deps = ["AtomsBase", "Chemfiles", "ExtXYZ", "Logging", "PeriodicTable", "Reexport", "Unitful", "UnitfulAtomic", "XCrySDenStructureFormat"]
git-tree-sha1 = "3517118177137a43e0447c46c2fe89a637b66897"
...
[[deps.XCrySDenStructureFormat]]
deps = ["AtomsBase", "PeriodicTable", "Printf", "Unitful", "UnitfulAtomic"]
git-tree-sha1 = "2fb3a2fb3e915c882ace77d2acbf2f515f0533c0"
uuid = "02310045-4665-40c9-a658-98c497d2eca9"
version = "0.1.1"
